...
def primary_price(rec):
    # Steven wants new-car listings to lead with MSRP. Used cars lead with selling price.
    if rec.get('condition') == 'new' and rec.get('msrp'):
        return rec['msrp'], 'MSRP'
    return rec.get('price'), 'Price'
